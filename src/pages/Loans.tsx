    ...
    return (
      <div className="max-w-5xl mx-auto w-full px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          <div>
            <Skeleton className="h-10 w-64 mb-2 animate-pulse" />
            <Skeleton className="h-4 w-48 animate-pulse" />
          </div>
          <Skeleton className="h-[70px] w-48 rounded-2xl animate-pulse" />
        </div>
        <Skeleton className="h-[120px] w-full rounded-[2rem] mb-10 animate-pulse" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <Skeleton className="h-40 rounded-3xl animate-pulse" />
          <Skeleton className="h-40 rounded-3xl animate-pulse" />
        </div>
