  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      {budgets.length === 0 ? (
        <EmptyState
          icon={Target}
          title="Start by setting your first budget"
          description="Budgets help you track spending by category and ensure you're staying within your financial limits."
