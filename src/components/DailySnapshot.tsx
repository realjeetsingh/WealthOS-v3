      ...
      <div className="flex flex-col md:flex-row gap-6 relative z-10">
        ...
        <div className="flex flex-col justify-center items-end gap-3 min-w-[200px]">
          ...
          <button 
            ...
            className="flex items-center gap-3 bg-indigo-600 p-4 rounded-2xl text-white shadow-lg shadow-indigo-100 w-full md:w-auto group cursor-pointer hover:bg-indigo-700 transition-all outline-none border-none text-left focus:ring-2 focus:ring-indigo-500/50"
          >
